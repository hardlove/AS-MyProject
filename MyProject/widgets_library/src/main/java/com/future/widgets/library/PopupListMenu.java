package com.future.widgets.library;
...
public class PopupListMenu {
    ...
    private static final float DEFAULT_TEXT_SIZE_PIXEL = 60;
    ...
    private void showPopupListWindow() {
        ...
        if (mPopupWindow == null) {
            ...
            final LinearLayout popupListContainer = new LinearLayout(mContext);
            ...
            if (mIndicatorView != null) {
                ...
                /**
                 * fix to add default arrow
                 */
                ImageView view = new ImageView(mContext);
                view.setImageResource(R.mipmap.popup_menu_list_default_arrow);
                mIndicatorView = view;
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(dp2px(16), dp2px(8));
                layoutParams.gravity = Gravity.CENTER;
                mIndicatorView.setLayoutParams(layoutParams);
                contentView.addView(mIndicatorView);
            }
...
//                    textView.setBackgroundDrawable(mContext.getResources().getDrawable(R.drawable.popup_list_menu_center_item_bg));
                ...
                if (mPopupItemList.size() > 1 && i != mPopupItemList.size() - 1) {
                    ...
                    LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(mDividerWidthPixel, LinearLayout.LayoutParams.MATCH_PARENT);
                    layoutParams.gravity = Gravity.CENTER;
